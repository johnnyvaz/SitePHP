                            ...
                            <table class="table">
                                ...
                                @foreach($imagens as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->ativo }}</td>
                                        <td>
                                            <a href="{{ url('/admin/imagens/' . $item->id) }}" title="View Imagen"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/imagens/' . $item->id . '/edit') }}" title="Edit Imagen"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
