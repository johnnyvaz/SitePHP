...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Imagem {{ $imagen->id }}</div>
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/imagens/' . $imagen->id . '/edit') }}" title="Edit Imagen"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
